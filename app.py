...
@app.route('/')
def home():
    return "<h1 style='background:#0f1419;color:#00FF88;padding:40px;font-family:Arial'>🛕 TTD API LIVE! 🙏<br><small style='color:#FFD700'>Try /dashboard /places /rooms /phrases</small></h1>"
...
h1{color:#FFD700;font-size:20px;text-align:center}
